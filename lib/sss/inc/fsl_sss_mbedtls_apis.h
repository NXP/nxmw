...
/** @copydoc sss_mbedtls_asymmetric_sign_one_go
 *
 */
...
/** @copydoc sss_mbedtls_cipher_finish
 *
 */
...
#       define sss_derive_key_one_go(context,saltKeyObject,info,infoLen,derivedKeyObject,deriveDataLen) \
            sss_mbedtls_derive_key_one_go(((sss_mbedtls_derive_key_t * ) context),(saltKeyObject),(info),(infoLen),(derivedKeyObject),(deriveDataLen))
...
#       define sss_derive_key_dh_two_step_part1(context) \
            sss_mbedtls_derive_key_dh_two_step_part1(((sss_mbedtls_derive_key_t * ) context))
#       define sss_derive_key_dh_two_step_part2(context,otherPartyKeyObject,derivedKeyObject) \
            sss_mbedtls_derive_key_dh_two_step_part2(((sss_mbedtls_derive_key_t * ) context),((sss_mbedtls_object_t * ) otherPartyKeyObject),((sss_mbedtls_object_t * ) derivedKeyObject))
...
#       define sss_asymmetric_sign_one_go(context,srcData,srcLen,signature,signatureLen) \
            sss_mbedtls_asymmetric_sign_one_go(((sss_mbedtls_asymmetric_t * ) context),(srcData),(srcLen),(signature),(signatureLen))
#       define sss_asymmetric_verify_one_go(context,srcData,srcLen,signature,signatureLen) \
            sss_mbedtls_asymmetric_verify_one_go(((sss_mbedtls_asymmetric_t * ) context),(srcData),(srcLen),(signature),(signatureLen))
#       define sss_asymmetric_sign_init(context,srcData,srcLen) \
            sss_mbedtls_asymmetric_sign_init(((sss_mbedtls_asymmetric_t * ) context),(srcData),(srcLen))
#       define sss_asymmetric_sign_update(context,srcData,srcLen) \
            sss_mbedtls_asymmetric_sign_update(((sss_mbedtls_asymmetric_t * ) context),(srcData),(srcLen))
#       define sss_asymmetric_sign_finish(context,srcData,srcLen,signature,signatureLen) \
            sss_mbedtls_asymmetric_sign_finish(((sss_mbedtls_asymmetric_t * ) context),(srcData),(srcLen),(signature),(signatureLen))
#       define sss_asymmetric_verify_init(context,srcData,srcLen) \
            sss_mbedtls_asymmetric_verify_init(((sss_mbedtls_asymmetric_t * ) context),(srcData),(srcLen))
#       define sss_asymmetric_verify_update(context,srcData,srcLen) \
            sss_mbedtls_asymmetric_verify_update(((sss_mbedtls_asymmetric_t * ) context),(srcData),(srcLen))
#       define sss_asymmetric_verify_finish(context,srcData,srcLen,signature,signatureLen) \
            sss_mbedtls_asymmetric_verify_finish(((sss_mbedtls_asymmetric_t * ) context),(srcData),(srcLen),(signature),(signatureLen))
        /* Direct Call : symm */
