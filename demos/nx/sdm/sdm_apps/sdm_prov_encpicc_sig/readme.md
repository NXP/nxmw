# SDM Provision to enable Encryption for PICCData and Sign Operation

This project is used to enable and configure SDM. After running this
demo, ex_sdm_prov_encpicc_sig/ex_sdm_prov_encpicc_sig can be used to read out data from
file and decrypt the piccdata and verify the signature.
...
- Change file 2 setting
    ...
    4. Disable SDMReadCtr mirroring
    5. Disable SDMReadCtrLimit
    6. Encrypt PICCData mirroring with AppKey 1 (`EX_SSS_SDM_AES_KEY_ID`)
    7. Enable SDM File Data Sign with ECC Key 2 (`EX_SSS_SDM_ECC_KEY_ID`) or
...
nx_mw :INFO :Defer Enable: 0
nx_mw :INFO :VCUID Enable: 1
nx_mw :INFO :SDMReadCtr Enable: 1
nx_mw :INFO :SDMReadCtrLimit Enable: 0
nx_mw :INFO :SDMENCFileData Enable: 0
nx_mw :INFO :GPIOStatus Enable: 0
nx_mw :INFO :SDMMetaRead: 0x1
nx_mw :INFO :SDMFileRead: 0x0
nx_mw :INFO :SDMFileRead2: 0x0
nx_mw :INFO :SDMCtrRet: 0x0
nx_mw :INFO :VCUIDOffset: 0x1b
nx_mw :INFO :SDMReadCtrOffset: 0x2c
nx_mw :INFO :PICCDataOffset: 0x20
nx_mw :INFO :GPIOStatusOffset: 0x0
nx_mw :INFO :SDMMACInputOffset: 0x1b
nx_mw :INFO :SDMENCOffset: 0x60
nx_mw :INFO :SDMENCLength: 0x20
nx_mw :INFO :SDMMACOffset: 0x43
nx_mw :INFO :SDMReadCtrLimit: 0x0
nx_mw :INFO :Defer SDM Encryption Enable: 0
nx_mw :INFO :Defer Method: 0x0
nx_mw :INFO :NDEF URL Untag.nxp.com/xdna?v=EE&e=000102030405060708090A0B0C0D0E0F&s=5E0F5E417050E741D666AA1E4E2E51BE6ACCFF92E7AA0093DC8DDBB0276BB6AA7E1E22C42B66C7C1D0E477916FBCE499F5EE67805960B3035714132B3AD774E3þ

nx_mw :INFO :ex_sdm_prov_encpicc_sig Setting Example Success !!!...
