...
#
# ksdk_frdmmcxa156.cmake

FILE(
    GLOB
    KSDK_STARTUP_FILE
    ${NXMW_TOP_DIR}/../mcuxsdk/devices/MCX/MCXA/MCXA156/gcc/startup_MCXA156.S
...
INCLUDE_DIRECTORIES(
    ${NXMW_TOP_DIR}/boards/frdmmcxa156/
)
...
SET(
    _FLAGS_L_LD
    " \
-T${NXMW_TOP_DIR}/../mcuxsdk/devices/MCX/MCXA/MCXA156/gcc/MCXA156_flash.ld \
-static "
)
