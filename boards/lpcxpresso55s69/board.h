...
#ifndef BOARD_PIO1_5_GPIO_PIN
#define BOARD_PIO1_5_GPIO_PIN 5U
#endif

#ifndef BOARD_PIO1_8_GPIO_PIN
#define BOARD_PIO1_8_GPIO_PIN 8U
#endif
...
#define LED_RED_ON() \
    GPIO_PortClear(  \
        BOARD_LED_RED_GPIO, BOARD_LED_RED_GPIO_PORT, 1U << BOARD_LED_RED_GPIO_PIN) /*!< Turn on target LED1 */
#define LED_RED_OFF()                \
...
#define LED_RED_TOGGLE() \
    GPIO_PortToggle(     \
        BOARD_LED_RED_GPIO, BOARD_LED_RED_GPIO_PORT, 1U << BOARD_LED_RED_GPIO_PIN) /*!< Toggle on target LED1 */

#define LED_BLUE_INIT(output)                                                                        \
    {                                                                                                \
        IOCON_PinMuxSet(IOCON, BOARD_LED_BLUE_GPIO_PORT, BOARD_LED_BLUE_GPIO_PIN, IOCON_DIGITAL_EN); \
        GPIO_PinInit(BOARD_LED_BLUE_GPIO,                                                            \
...
#define LED_BLUE_ON() \
    GPIO_PortClear(   \
        BOARD_LED_BLUE_GPIO, BOARD_LED_BLUE_GPIO_PORT, 1U << BOARD_LED_BLUE_GPIO_PIN) /*!< Turn on target LED1 */
#define LED_BLUE_OFF() \
    GPIO_PortSet(      \
        BOARD_LED_BLUE_GPIO, BOARD_LED_BLUE_GPIO_PORT, 1U << BOARD_LED_BLUE_GPIO_PIN) /*!< Turn off target LED1 */
#define LED_BLUE_TOGGLE() \
    GPIO_PortToggle(      \
        BOARD_LED_BLUE_GPIO, BOARD_LED_BLUE_GPIO_PORT, 1U << BOARD_LED_BLUE_GPIO_PIN) /*!< Toggle on target LED1 */

#define LED_GREEN_INIT(output)         \
    GPIO_PinInit(BOARD_LED_GREEN_GPIO, \
        BOARD_LED_GREEN_GPIO_PORT,     \
        BOARD_LED_GREEN_GPIO_PIN,      \
        &(gpio_pin_config_t){kGPIO_DigitalOutput, (output)}) /*!< Enable target LED1 */
#define LED_GREEN_ON() \
    GPIO_PortClear(    \
        BOARD_LED_GREEN_GPIO, BOARD_LED_GREEN_GPIO_PORT, 1U << BOARD_LED_GREEN_GPIO_PIN) /*!< Turn on target LED1 */
#define LED_GREEN_OFF() \
    GPIO_PortSet(       \
        BOARD_LED_GREEN_GPIO, BOARD_LED_GREEN_GPIO_PORT, 1U << BOARD_LED_GREEN_GPIO_PIN) /*!< Turn off target LED1 */
#define LED_GREEN_TOGGLE() \
    GPIO_PortToggle(       \
        BOARD_LED_GREEN_GPIO, BOARD_LED_GREEN_GPIO_PORT, 1U << BOARD_LED_GREEN_GPIO_PIN) /*!< Toggle on target LED1 */
