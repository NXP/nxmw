...
/** @file
 *
 * platform_frdmmcxa156.c:  Contains the code specific to mcxa156 platform
 *
 */
...
#if defined(SSS_HAVE_HOST_FRDMMCXA156) && (SSS_HAVE_HOST_FRDMMCXA156)
...
#endif //#if defined(SSS_HAVE_HOST_FRDMMCXA156) && (SSS_HAVE_HOST_FRDMMCXA156)
