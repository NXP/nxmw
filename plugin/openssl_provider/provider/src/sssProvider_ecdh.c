...
static int sss_ecdh_keyexch_derive(void *ctx, unsigned char *secret, size_t *secretlen, size_t outlen)
{
    ...
    if (pEcdhctx->pStoreObjCtx->isEVPKey == 0) {
        ...
        pSession = (sss_nx_session_t *)&(pEcdhctx->pProvCtx->p_ex_sss_boot_ctx->session);
        ...
        if (secret == NULL) {
            ...
            *secretlen = (size_t)evp_secretLen;
            ...
            sssProv_Print(LOG_FLOW_ON, "Performing ECDH on Secure Authenticator \n");
            sssProv_Print(
        ...
        if (secret == NULL) {
            ...
            *secretlen = (size_t)evp_secretLen;
            ...
            sssProv_Print(LOG_FLOW_ON, "Not a key in Secure Authenticator. Performing ECDH on host software \n");
