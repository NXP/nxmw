...
def nxclitool_connect(nxclitool, smcom, port, auth="symmetric", sctunn="ntag_aes128_ev2", key_id="0x00"):
...
def main():
    ...
    nxclitool_connect(nxclitool, smcom=args.smcom, port=port_name)
    nxclitool_setkey(nxclitool, "0x02", curve, key_path, "sign")
    nxclitool_setkey(nxclitool, "0x03", curve, key_path, "ecdh")
